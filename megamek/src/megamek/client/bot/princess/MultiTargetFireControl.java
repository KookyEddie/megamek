...
public class MultiTargetFireControl extends FireControl {
    ...
    protected FiringPlan calculateFiringPlan(Entity shooter, List<WeaponMounted> weaponList) {
        ...
        boolean shooterIsLarge = shooter.hasETypeFlag(EntityTypeConstants.ETYPE_DROPSHIP) ||
                shooter.hasETypeFlag(EntityTypeConstants.ETYPE_JUMPSHIP) ||
                shooter.hasETypeFlag(EntityTypeConstants.ETYPE_SMALL_CRAFT);
