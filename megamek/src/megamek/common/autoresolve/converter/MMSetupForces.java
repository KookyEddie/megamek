...
public class MMSetupForces extends SetupForces {
    ...
    private Player getCleanPlayer(Player originalPlayer) {
        ...
        player.deploymentConfig.setStartingPos(originalPlayer.deploymentConfig.getStartingPos());
        player.deploymentConfig.setStartOffset(originalPlayer.deploymentConfig.getStartOffset());
        player.deploymentConfig.setStartWidth(originalPlayer.deploymentConfig.getStartWidth());
        player.deploymentConfig.setStartingAnyNWx(originalPlayer.deploymentConfig.getStartingAnyNWx());
        player.deploymentConfig.setStartingAnyNWy(originalPlayer.deploymentConfig.getStartingAnyNWy());
        player.deploymentConfig.setStartingAnySEx(originalPlayer.deploymentConfig.getStartingAnySEx());
        player.deploymentConfig.setStartingAnySEy(originalPlayer.deploymentConfig.getStartingAnySEy());
